...
async function main() {
  try {
    ...
    try {
      ...
      // console.log("\n--> Submit Transaction: Adding Candidate");
      // await contract.submitTransaction(
      //   "AddCandidate",
      //   "candidate2",
      //   "shahriar",
      ...
      //   "user4",
      //   "saifullah",
      //   "saifullah2069@gmail.com",
      //   "abcd12"
      // );
      // console.log("*** Result: committed");

      // console.log("\n--> Evaluate Transaction: showing all candidates");
      ...
      // result = await contract.evaluateTransaction("SayHello");
      // console.log(`*** Result: ${prettyJSONString(result.toString())}`);
